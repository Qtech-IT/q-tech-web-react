...
/**
 * `Container` sizes, indexed by the editor's `measure` choice.
 *
 * `narrow` is the `--fx-measure-prose` token — 704px, roughly 72 characters at
...
export function ContentProse({ section, index }: SectionComponentProps) {
  ...
  return (
    <Section
      ...
      containerSize={MEASURE_SIZES[measure]}
