 ...
 * which names them `{resourceKey}.{action}` — so `folder.view`, `folder.create`.
...
class MediaFolderPolicy
{
    ...
    {
        return $user->hasPermissionTo('folder.view');
    }
    ...
    {
        return $user->hasPermissionTo('folder.edit');
    }

    public function delete(User $user): bool
    {
        return $user->hasPermissionTo('folder.delete');
    }
    ...
    {
        return $user->hasPermissionTo('folder.restore');
    }
    ...
    {
        return $user->hasPermissionTo('folder.force-delete');
    }
}
