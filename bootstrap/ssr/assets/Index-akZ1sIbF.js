...
import { AlertTriangle, BookOpen, CheckCircle, Circle, Edit, Filter, FolderOpen, Image, LucideNewspaper, MoreHorizontal, NewspaperIcon, PlusCircle, Search, Tag, Trash2, X, XCircle } from "lucide-react";
import "motion/react";
...
import { b as blogFilterOptions, a as getBlogDeleteDialogConfig, c as getBlogsBreadcrumbItems, g as getBlogStats, h as onBlogBulkAction, d as onBlogDelete, f as onBlogFilterChange, e as onBlogSearch, o as onBlogStatusUpdate } from "./BlogController-D6kflUCs.js";
...
function OverviewCard({ stats }) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    /* @__PURE__ */ jsx(Card, {
      ...
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-12 h-12 bg-blue-100 rounded-lg dark:bg-blue-900", children: /* @__PURE__ */ jsx(NewspaperIcon, { className: "w-6 h-6 text-blue-600 dark:text-blue-400" }) }),
      /* @__PURE__ */ jsxs("div", {
            children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-blue-700 dark:text-blue-300", children: "Total Blogs" }),
...
const TableActions = ({ item, onDelete }) => {
  ...
  const handleEdit = () => {
    router.visit(route("admin.blogs.edit", item.id));
  };
  const handleDelete = () => {
    onDelete(item.id);
  };
  const handleStatusUpdate = (newStatus) => {
    onBlogStatusUpdate(item, newStatus, submit);
  };
...
const CategoriesBadge = ({ categories }) => {
  if (!categories || categories.length === 0) return /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-500", children: "No categories" });
  return /* @__PURE__ */ jsxs("div", {
    className: "flex flex-wrap gap-1", children: [
      categories.slice(0, 2).map((category) => /* @__PURE__ */ jsxs(
        Badge,
        {
          variant: "outline",
          className: "text-xs text-blue-700 border-blue-200 dark:text-blue-300 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/20",
          children: [
      ...
      categories.length > 2 && /* @__PURE__ */ jsxs(
        Badge,
        {
          variant: "outline",
...
const TagsBadge = ({ tags }) => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "flex flex-wrap gap-1 mt-1", children: [
      tags.slice(0, 3).map((tag) => /* @__PURE__ */ jsxs(
        Badge,
        {
          variant: "secondary",
          className: "text-xs text-green-700 border-green-200 dark:text-green-300 dark:border-green-600 bg-green-50 dark:bg-green-900/20",
          children: [
          /* @__PURE__ */ jsx(Tag, { className: "w-2 h-2 mr-1" }),
            tag.name
          ]
        },
        tag.id
      )),
      tags.length > 3 && /* @__PURE__ */ jsxs(
        Badge,
        {
          variant: "secondary",
...
const BlogTable = ({
  ...
  const handleSelectAll = (checked) => {
    if (checked) {
      setSelectedItems(blogs.map((b) => b.id));
    } else {
      setSelectedItems([]);
    }
  };
  ...
  const bulkActionConfig = {
    title: "Bulk Blog Actions",
    description: `Apply an action to ${selectedItems.length} selected blogs.`,
    actions: [
      {
        value: "active",
        label: "Publish Selected",
        icon: CheckCircle,
        description: "Make selected blogs visible to readers"
      },
      {
        value: "inactive",
        label: "Unpublish Selected",
        icon: XCircle,
        description: "Hide selected blogs from readers"
      },
      {
        value: "delete",
        label: "Delete Selected",
        icon: AlertTriangle,
        description: "Permanently remove selected blogs"
      }
    ],
    warningMessage: `This action will affect ${selectedItems.length} blogs. This action cannot be undone.`,
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    ...
    /* @__PURE__ */ jsx(Card, {
      ...
      /* @__PURE__ */ jsx(TableHeader, {
        ...
        /* @__PURE__ */ jsx(TableHead, {
                  className: "w-12 px-6 py-3", children: /* @__PURE__ */ jsx(
                    Checkbox,
                    {
                      checked: selectedItems.length === blogs.length && blogs.length > 0,
        ...
        /* @__PURE__ */ jsx(TableHead, { className: "px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-300", children: "Blog Post" }),
        ...
        /* @__PURE__ */ jsx(TableHead, { className: "px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-300", children: "Categories" }),
        /* @__PURE__ */ jsx(TableHead, { className: "px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-300", children: "Tags" }),
      ...
      /* @__PURE__ */ jsx(TableBody, {
              className: "bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700", children: blogs?.map((item, index) => /* @__PURE__ */ jsxs(TableRow, {
        ...
        /* @__PURE__ */ jsx(TableCell, {
          ...
          /* @__PURE__ */ jsx("div", {
                      ...
                      ) : /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-16 h-12 bg-gray-100 border rounded-lg dark:bg-gray-700", children: /* @__PURE__ */ jsx(Image, { className: "w-6 h-6 text-gray-400" }) })
                    }),
          /* @__PURE__ */ jsxs("div", {
                      className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-gray-900 truncate dark:text-gray-100", children: item.title }),
            /* @__PURE__ */ jsxs("div", {
                        className: "text-xs text-gray-500 truncate dark:text-gray-400", children: [
                          "/",
                          item.slug
                        ]
                      })
        ...
        /* @__PURE__ */ jsx(TableCell, { className: "px-6 py-4", children: /* @__PURE__ */ jsx(CategoriesBadge, { categories: item.categories }) }),
        /* @__PURE__ */ jsx(TableCell, { className: "px-6 py-4", children: /* @__PURE__ */ jsx(TagsBadge, { tags: item.tags }) }),
...
function Index({
  ...
  const filterOptions = blogFilterOptions(categories || []);
  const breadcrumbItems = getBlogsBreadcrumbItems();
  const stats = getBlogStats(currentData);
  const handleSearch = (searchValue) => {
    onBlogSearch(searchValue, setSearchTerm);
  };
  const handleFilterChange = (newFilters) => {
    onBlogFilterChange(newFilters, filterOptions, setActiveFilters, setSearchTerm);
  };
  const handleDeleteBlog = (id) => {
    const blogToDelete = currentData?.find((blog) => blog.id === id);
    if (blogToDelete) {
      setDeletingBlog(blogToDelete);
      setShowDeleteDialog(true);
    }
  };
  const handleBulkAction = (selectedIds, action) => {
    if (action && selectedIds.length > 0) {
      onBlogBulkAction(selectedIds, action, submit);
      setSelectedItems([]);
      setBulkAction("");
    }
  };
  const handleCreateBlog = () => {
    router.visit(route("admin.blogs.create"));
  };
  const deleteDialogConfig = getBlogDeleteDialogConfig(deletingBlog);
    ...
    /* @__PURE__ */ jsxs(Main, {
      ...
      /* @__PURE__ */ jsx(
          CommonLayoutHeader,
          {
            ...
            breadcrumbItems,
            title: "Blogs",
            description: "Organize and manage  blogs to categorize your content effectively",
