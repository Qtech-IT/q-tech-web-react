...
import { d as handleResendOtp, c as handleVerifyOtp } from "./AppLayout-BOaFJ-XR.js";
...
const OtpVerificationForm = () => {
  ...
  const onSubmit = (e) => {
    handleVerifyOtp(e, formData, submit);
  };
  const onResend = () => {
    handleResendOtp(resendSubmit);
  };
  return /* @__PURE__ */ jsxs(Card, {
    className: "w-full max-w-xl mx-auto border shadow-xl animate-slide-up", children: [
    /* @__PURE__ */ jsxs(CardHeader, {
      className: "pb-8 space-y-1", children: [
      /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-4", children: /* @__PURE__ */ jsx("div", { className: "p-4 bg-green-100 rounded-full dark:bg-green-900", children: /* @__PURE__ */ jsx(Mail, { className: "w-8 h-8 text-green-600 dark:text-green-400" }) }) }),
      /* @__PURE__ */ jsx(CardTitle, { className: "text-2xl font-bold text-center text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text", children: "OTP Verification" }),
      /* @__PURE__ */ jsx(CardDescription, {
        className: "text-center text-gray-600 dark:text-gray-400", children: email ? /* @__PURE__ */ jsxs(Fragment, {
          children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, {
      children: [
      /* @__PURE__ */ jsx(Alert, { className: "mb-6 border-blue-200 bg-blue-50 dark:bg-blue-950", children: /* @__PURE__ */ jsx(AlertDescription, { className: "text-sm text-center", children: "Check your inbox and spam folder. The code expires in 10 minutes." }) }),
      /* @__PURE__ */ jsxs("form", {
...
const OtpVerification = ({ title }) => {
  return /* @__PURE__ */ jsxs(Fragment, {
    ...
    /* @__PURE__ */ jsx(AuthLayout, { children: /* @__PURE__ */ jsx(OtpVerificationForm, {}) })
    ]
  });
};
export {
