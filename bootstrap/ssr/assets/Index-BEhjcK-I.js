...
import { c as categories, t as timeframes, a as markets } from "./demo-data-C5EGh9Nk.js";
...
const MarketSection = ({ isMarket = true }) => {
  const { url } = usePage();
  ...
  const clearMarketFilter = () => {
    setSearchQuery("");
    setSelectedCategory(valueToKey("All Markets"));
    setSelectedVolume("");
  ...
  return /* @__PURE__ */ jsx("section", { className: `${isMarket ? "pt-4 lg:pb-24 mb:pb-20 pb-16" : "lg:py-24 mb:py-20 py-16"}`, children: /* @__PURE__ */ jsxs("div", { className: "container px-4 mx-auto", children: [
    isMarket ? /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end justify-end gap-4 mb-4 md:items-center md:flex-row", children: [
        subCategories?.length > 0 && /* @__PURE__ */ jsx("div", { className: "w-full overflow-x-hidden grow", children: /* @__PURE__ */ jsx(MenuScroller, { children: /* @__PURE__ */ jsx("ul", { className: "flex items-center gap-2 text-sm text-muted-foreground whitespace-nowrap", children: subCategories.map((sub) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: "#", className: "flex items-center h-8 px-4 font-medium rounded-full border-1 hover:border-primary hover:bg-primary/10 hover:text-primary text-sm/5", children: sub.label }) }, sub.label)) }) }) }),
    ...
    /* @__PURE__ */ jsx(MarketGrid, { filteredMarkets }),
    /* @__PURE__ */ jsx(PaginationWrapper, {})
  ] }) });
};
const Index = () => {
  const isMarket = true;
  return /* @__PURE__ */ jsx(AppLayout, { isMarket, children: /* @__PURE__ */ jsx(MarketSection, { isMarket }) });
};
export {
  Index as default
};
