...
import { AlertTriangle, CheckCircle, Circle, Edit, Filter, MoreHorizontal, PlusCircle, Search, Shield, Trash2, Users, X, XCircle } from "lucide-react";
import "motion/react";
...
import { a as getRoleDeleteDialogConfig, b as getRolesBreadcrumbItems, g as getRoleStats, f as onRoleBulkAction, c as onRoleDelete, e as onRoleFilterChange, d as onRoleSearch, o as onRoleStatusUpdate, r as roleFilterOptions } from "./RoleController-Dowu4kpP.js";
...
function OverviewCard({ stats }) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    /* @__PURE__ */ jsx(Card, {
      ...
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-12 h-12 bg-blue-100 rounded-lg dark:bg-blue-900", children: /* @__PURE__ */ jsx(Shield, { className: "w-6 h-6 text-blue-600 dark:text-blue-400" }) }),
      /* @__PURE__ */ jsxs("div", {
            children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-blue-700 dark:text-blue-300", children: "Total Roles" }),
    ...
    /* @__PURE__ */ jsx(Card, {
      className: "border-purple-200 bg-purple-50 dark:bg-purple-950 dark:border-purple-800", children: /* @__PURE__ */ jsx(CardContent, {
        className: "p-6", children: /* @__PURE__ */ jsxs("div", {
          className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-12 h-12 bg-purple-100 rounded-lg dark:bg-purple-900", children: /* @__PURE__ */ jsx(Users, { className: "w-6 h-6 text-purple-600 dark:text-purple-400" }) }),
      /* @__PURE__ */ jsxs("div", {
            children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-purple-700 dark:text-purple-300", children: "Total Users" }),
        /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-purple-900 dark:text-purple-100", children: stats.totalUsers })
            ]
          })
          ]
        })
    ...
    /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Find roles quickly" })
          ]
        })
        ]
      }),
...
const TableActions = ({ item, onDelete }) => {
  ...
  const handleStatusUpdate = (newStatus) => {
    onRoleStatusUpdate(item, newStatus, submit);
  };
...
const RoleTable = ({
  ...
  const handleSelectAll = (checked) => {
    if (checked) {
      setSelectedItems(roles.map((r) => r.id));
    } else {
      setSelectedItems([]);
    }
  };
  ...
  const bulkActionConfig = {
    title: "Bulk Role Actions",
    description: `Apply an action to ${selectedItems.length} selected roles.`,
    actions: [
      {
        value: "active",
        label: "Activate Selected",
        icon: CheckCircle,
        description: "Make selected roles active"
      },
      {
        value: "inactive",
        label: "Deactivate Selected",
        icon: XCircle,
        description: "Disable selected roles"
      },
      {
        value: "delete",
        label: "Delete Selected",
        icon: AlertTriangle,
        description: "Permanently remove selected roles"
      }
    ],
    warningMessage: `This action will affect ${selectedItems.length} roles. This action cannot be undone.`,
  ...
  if (roles.length === 0) {
    return /* @__PURE__ */ jsx(
      EmptyTableState,
      {
        ...
        description: "No roles configured. Create your first role to get started."
      }
    );
  }
  return /* @__PURE__ */ jsxs(Fragment, {
    ...
    /* @__PURE__ */ jsx(Card, {
      ...
      /* @__PURE__ */ jsx(TableHeader, {
        ...
        /* @__PURE__ */ jsx(TableHead, { className: "px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-300", children: "Role Name" }),
        /* @__PURE__ */ jsx(TableHead, { className: "px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-300", children: "Permissions" }),
        /* @__PURE__ */ jsx(TableHead, { className: "px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-300", children: "Users" }),
      ...
      /* @__PURE__ */ jsx(TableBody, {
              className: "bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700", children: roles?.map((item, index) => {
          ...
          /* @__PURE__ */ jsx(TableCell, {
                    className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", {
                      className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600", children: /* @__PURE__ */ jsx(Shield, { className: "w-5 h-5 text-white" }) }),
          ...
          /* @__PURE__ */ jsx(TableCell, {
            ...
            /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-900 dark:text-gray-100", children: item.admins_count || 0 })
                      ]
                    })
                  }),
...
function Index({
  ...
  const breadcrumbItems = getRolesBreadcrumbItems();
  const stats = getRoleStats(currentData);
  const handleSearch = (searchValue) => {
    onRoleSearch(searchValue, setSearchTerm);
  };
  const handleFilterChange = (newFilters) => {
    onRoleFilterChange(newFilters, filterOptions, setActiveFilters, setSearchTerm);
  };
  const handleDeleteRole = (id) => {
    const roleToDelete = currentData?.find((role) => role.id === id);
    if (roleToDelete) {
  ...
  const handleBulkAction = (selectedIds, action) => {
    if (action && selectedIds.length > 0) {
      onRoleBulkAction(selectedIds, action, submit);
      setSelectedItems([]);
      setBulkAction("");
    }
  };
  ...
  const deleteDialogConfig = getRoleDeleteDialogConfig(deletingRole);
