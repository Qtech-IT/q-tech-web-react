...
import { AlertTriangle, ArrowRightLeft, CheckCircle, Circle, CreditCard, Edit, FileText, Filter, MoreHorizontal, PlusCircle, Search, Trash2, X, XCircle, Zap } from "lucide-react";
import "motion/react";
...
import { a as getPaymentMethodDeleteDialogConfig, b as getPaymentMethodsBreadcrumbItems, g as getPaymentMethodStats, f as onPaymentMethodBulkAction, c as onPaymentMethodDelete, e as onPaymentMethodFilterChange, d as onPaymentMethodSearch, o as onPaymentMethodStatusUpdate, p as paymentMethodFilterOptions } from "./PaymentMethodController-w4wfQ0gi.js";
...
function OverviewCard({ stats }) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    /* @__PURE__ */ jsx(Card, {
      ...
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-12 h-12 bg-blue-100 rounded-lg dark:bg-blue-900", children: /* @__PURE__ */ jsx(CreditCard, { className: "w-6 h-6 text-blue-600 dark:text-blue-400" }) }),
      /* @__PURE__ */ jsxs("div", {
            children: [
    ...
    /* @__PURE__ */ jsx(Card, {
      className: "border-purple-200 bg-purple-50 dark:bg-purple-950 dark:border-purple-800", children: /* @__PURE__ */ jsx(CardContent, {
        className: "p-6", children: /* @__PURE__ */ jsxs("div", {
          className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-12 h-12 bg-purple-100 rounded-lg dark:bg-purple-900", children: /* @__PURE__ */ jsx(Zap, { className: "w-6 h-6 text-purple-600 dark:text-purple-400" }) }),
      /* @__PURE__ */ jsxs("div", {
            children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-purple-700 dark:text-purple-300", children: "Automatic" }),
        /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-purple-900 dark:text-purple-100", children: stats.automatic })
            ]
          })
          ]
        })
    ...
    /* @__PURE__ */ jsx(Card, {
      className: "border-orange-200 bg-orange-50 dark:bg-orange-950 dark:border-orange-800", children: /* @__PURE__ */ jsx(CardContent, {
        className: "p-6", children: /* @__PURE__ */ jsxs("div", {
          className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center w-12 h-12 bg-orange-100 rounded-lg dark:bg-orange-900", children: /* @__PURE__ */ jsx(FileText, { className: "w-6 h-6 text-orange-600 dark:text-orange-400" }) }),
      /* @__PURE__ */ jsxs("div", {
            children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-orange-700 dark:text-orange-300", children: "Manual" }),
        /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-orange-900 dark:text-orange-100", children: stats.manual })
            ]
          })
          ]
        })
    ...
    /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Find payment methods quickly" })
          ]
        })
        ]
      }),
...
const TableActions = ({ item, onDelete }) => {
  ...
  const handleEdit = () => {
    router.visit(route("admin.payment-methods.edit", item.id));
  };
  const handleDelete = () => {
    onDelete(item.id);
  };
  const handleStatusUpdate = (newStatus) => {
    onPaymentMethodStatusUpdate(item, newStatus, submit);
  };
  return /* @__PURE__ */ jsxs(DropdownMenu, {
    ...
    /* @__PURE__ */ jsxs(DropdownMenuContent, {
      ...
      /* @__PURE__ */ jsxs(DropdownMenuSub, {
        ...
        item?.is_manual && /* @__PURE__ */ jsxs(Fragment, {
          children: [
        /* @__PURE__ */ jsx(DropdownMenuSeparator, { className: "dark:bg-gray-700" }),
        /* @__PURE__ */ jsxs(
            DropdownMenuItem,
...
const TypeBadge = ({ isManual }) => {
  return isManual ? /* @__PURE__ */ jsxs(Badge, {
    variant: "outline", className: "text-xs text-orange-700 border-orange-200 dark:text-orange-300 dark:border-orange-600 bg-orange-50 dark:bg-orange-900/20", children: [
    /* @__PURE__ */ jsx(FileText, { className: "w-3 h-3 mr-1" }),
      "Manual"
    ]
  }) : /* @__PURE__ */ jsxs(Badge, {
    variant: "outline", className: "text-xs text-purple-700 border-purple-200 dark:text-purple-300 dark:border-purple-600 bg-purple-50 dark:bg-purple-900/20", children: [
  ...
  if (methods.length === 0) {
    return /* @__PURE__ */ jsx(
      EmptyTableState,
      {
        ...
        description: "No payment methods configured. Create your first method to get started."
      }
    );
  }
  return /* @__PURE__ */ jsxs(Fragment, {
    ...
    /* @__PURE__ */ jsx(Card, {
      ...
      /* @__PURE__ */ jsx(TableHeader, {
        ...
        /* @__PURE__ */ jsx(TableHead, { className: "px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-700 uppercase dark:text-gray-300", children: "Fees" }),
      ...
      /* @__PURE__ */ jsx(TableBody, {
        ...
        /* @__PURE__ */ jsx(TableCell, {
                  className: "px-6 py-4", children: /* @__PURE__ */ jsx(
                    Checkbox,
                    {
                      ...
                      checked: !item?.is_manual ? false : selectedItems.includes(item.id),
        ...
        /* @__PURE__ */ jsx(TableCell, {
                  className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", {
                    className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600", children: /* @__PURE__ */ jsx(CreditCard, { className: "w-5 h-5 text-white" }) }),
        ...
        /* @__PURE__ */ jsx(TableCell, { className: "px-6 py-4", children: /* @__PURE__ */ jsx("code", { className: "px-2 py-1 text-xs bg-gray-100 rounded dark:bg-gray-800", children: item.gateway_code }) }),
        /* @__PURE__ */ jsx(TableCell, { className: "px-6 py-4", children: /* @__PURE__ */ jsx(TypeBadge, { isManual: item.is_manual }) }),
        /* @__PURE__ */ jsx(TableCell, {
                  className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", {
                    className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx(TableCell, {
          ...
          /* @__PURE__ */ jsxs("div", {
                      className: "text-gray-500", children: [
                        "Fixed: ",
            /* @__PURE__ */ jsx("span", { className: "font-medium text-gray-900 dark:text-gray-100", children: item.fixed_fee })
                      ]
                    }),
          /* @__PURE__ */ jsxs("div", {
                      className: "text-gray-500", children: [
...
function Index({
  ...
  const filterOptions = paymentMethodFilterOptions();
  const breadcrumbItems = getPaymentMethodsBreadcrumbItems();
  const stats = getPaymentMethodStats(currentData);
  const handleSearch = (searchValue) => {
    onPaymentMethodSearch(searchValue, setSearchTerm);
  };
  const handleFilterChange = (newFilters) => {
    onPaymentMethodFilterChange(newFilters, filterOptions, setActiveFilters, setSearchTerm);
  };
  ...
  const handleBulkAction = (selectedIds, action) => {
    if (action && selectedIds.length > 0) {
      onPaymentMethodBulkAction(selectedIds, action, submit);
      setSelectedItems([]);
      setBulkAction("");
    }
  };
  const handleCreateMethod = () => {
    router.visit(route("admin.payment-methods.create"));
  };
  const deleteDialogConfig = getPaymentMethodDeleteDialogConfig(deletingMethod);
    ...
    /* @__PURE__ */ jsxs(Main, {
      ...
      /* @__PURE__ */ jsx(
          CommonLayoutHeader,
          {
            ...
            description: "Manage and configure payment gateways for your platform",
            icon: CreditCard,
            stats,
            primaryAction: {
              label: "Add Method",
      ...
      /* @__PURE__ */ jsx(
          SearchBox,
          {
            ...
            placeholder: "Search by method name, gateway code or currency...",
            filterOptions
          }
        ),
      /* @__PURE__ */ jsx("div", {
